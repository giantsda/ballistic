...
float qromb1(float (*func)(float), float a, float b);
...
float qromb2d(float (*func)(float, float), float x1, float x2);
...
double romint (double *, int, double);
double romavg (double *, int, int);
